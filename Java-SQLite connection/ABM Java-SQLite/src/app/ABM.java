...
public class ABM extends javax.swing.JFrame {
    ...
    public void cargarTabla(){
        try{
            ...
            String sql = "SELECT dni, nombre, apellido, estatura, masa FROM Persona";
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        try{
            ...
            ps = connection.prepareStatement("INSERT INTO Persona(dni, nombre, apellido, estatura, masa) VALUES(?, ?, ?, ?, ?)");
            ps.setString(1, txtDNI.getText());
            ps.setString(2, txtNombre.getText());
            ps.setString(3, txtApellido.getText());
            ps.setString(4, txtEstatura.getText());
            ps.setString(5, txtMasa.getText());
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try {
            ...
            ps = connection.prepareStatement("UPDATE Persona SET nombre = ?, apellido = ?, estatura = ?, masa = ? WHERE dni = ?");

            ps.setString(1, txtNombre.getText());
            ps.setString(2, txtApellido.getText());
            ps.setString(3, txtEstatura.getText());
            ps.setString(4, txtMasa.getText());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            ...
            ps = connection.prepareStatement("DELETE FROM Persona WHERE dni = ?");
            ps.setString(1, dni);
            ps.execute();
    ...
    private void tabPersonaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabPersonaMouseClicked
        ...
        try{
            ...
            ps = connection.prepareStatement("SELECT dni, nombre, apellido, estatura, masa FROM Persona WHERE dni = ?");
            ps.setString(1, dni);
            rs = ps.executeQuery();
            ...
            while(rs.next()){
                ...
                txtEstatura.setText(rs.getString("estatura"));
                txtMasa.setText(rs.getString("masa"));
            }
